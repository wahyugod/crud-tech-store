            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis" class="form-control <?= isset($errors['jenis']) ? 'error' : '' ?>" required>
                        ...
                        <option value="hp" <?= (($old['jenis'] ?? '') === 'hp') ? 'selected' : '' ?>>HP / Smartphone</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="harga" class="form-control <?= isset($errors['harga']) ? 'error' : '' ?>" 
                           value="<?= e($old['harga'] ?? '0') ?>" inputmode="numeric" 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="processor" class="form-control" 
                           value="<?= e($old['processor'] ?? '') ?>" placeholder="Contoh: Intel Core i5">
                </div>

                <div class="form-group">
                    <label class="form-label">VGA / GPU</label>
                    <input type="text" name="vga" class="form-control" 
                           value="<?= e($old['vga'] ?? '') ?>" placeholder="Contoh: NVIDIA GTX 1650">
                </div>

                <div class="form-group">
                    <label class="form-label">RAM</label>
                    <input type="text" name="ram" class="form-control" 
                           value="<?= e($old['ram'] ?? '') ?>" placeholder="Contoh: 8GB DDR4">
                </div>

                <div class="form-group">
                    <label class="form-label">Storage</label>
                    <input type="text" name="storage" class="form-control" 
                           value="<?= e($old['storage'] ?? '') ?>" placeholder="Contoh: 512GB SSD">
                </div>
            </div>
        </div>
